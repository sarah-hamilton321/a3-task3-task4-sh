...
```{r}
ggplot(data = purple_site_year, aes(x = year_new, y = count_urchins)) +
...
I think this graph indicates that there is a decrease in the purple sea urchin
...
ADD MORE TEXT HERE BEFORE SUMBITTING?????
Question from assignment:
"What would you have to take into account to determine whether the changes 
in counts by year are reflective of actual changes in urchin population? What 
else could explain the changes in number of purple urchins observed?"
